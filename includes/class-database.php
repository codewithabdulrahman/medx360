...
class MedX360_Database {
    ...
    public static function maybe_update() {
        ...
        MedX360_Migration::get_instance()->run_migrations();
    }
    
    /**
     * Add column to table safely
     */
    ...
    /**
     * Remove column from table safely
     */
    ...
    /**
     * Add index to table safely
     */
    public static function add_index($table, $index_name, $columns) {
        global $wpdb;
    ...
    /**
     * Remove index from table safely
     */
    public static function remove_index($table, $index_name) {
        global $wpdb;
